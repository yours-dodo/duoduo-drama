...
> Evidence is recorded only after the corresponding commands pass. The current implementation has completed S01–S05; the broader Protocol gate remains in progress until its remaining slices pass.
...
| Protocol             | in-progress | S03 and S05 Responses paths passed; S06–S12 remain.                                 |
