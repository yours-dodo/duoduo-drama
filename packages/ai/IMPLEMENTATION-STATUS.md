...
> Evidence is recorded only after the corresponding commands pass. The current implementation has completed S01–S06; the broader Protocol gate remains in progress until its remaining slices pass.
...
| Protocol             | in-progress | S03, S05, and S06 protocol paths passed; S07–S12 remain.                            |
